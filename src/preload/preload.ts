...
contextBridge.exposeInMainWorld('electronAPI', {
    // the renderer will call this function which will securely send a message 
    // to the main process of electron
    selectFolder: () => ipcRenderer.invoke('dialog:openDirectory'),
    // handleLogMessage just receives the message on the ipcRenderer on the 
